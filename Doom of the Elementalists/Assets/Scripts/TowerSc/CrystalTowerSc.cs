...
public class CrystalTowerSc : MonoBehaviour
{
    [Header("Attrebiutes")]
    ...
    public int CTowerUpgradeCost1 = 110;
    public int CTowerUpgradeCost2 = 125;
    public int CTowerUpgradeCost3 = 160;
    ...
    private void Update()
    {
        ...
        transform.rotation = Quaternion.Slerp(thistower.transform.rotation, q, Time.deltaTime * RotationSpeed);
        */
        if (FireCountDown <= 0)
        {
            Shoot();
